            ...
            {tab === 'terminal' && (
              <section className="space-y-4">
                <Card className="p-0 overflow-hidden border-zinc-800">
                  <div className="flex flex-wrap items-center justify-between gap-2 border-b border-zinc-800 bg-zinc-900 px-4 py-2.5">
                    <div className="flex items-center gap-2">
                      ...
                      {server && (
                        <span className="text-[11px] text-zinc-500 font-normal">
                          {getTerminalConnectionLabel(server)}
                        </span>
                      )}
                    </div>
                    <Button
                      ...
                      onClick={() =>
                        ...
                        openTerminalOverlay(serverId, server.name, {
                          connectionLabel: getTerminalConnectionLabel(server),
                          isLocal: isTerminalLocal(server),
                        })
                      }
                    >
                      Open at bottom
