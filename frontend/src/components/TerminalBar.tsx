...
import { api, canUseTerminal, getTerminalConnectionLabel, isTerminalLocal } from '../lib/api'
...
export function TerminalBar() {
  ...
  if (!canUseTerminal(user) || isOpen) return null
  ...
  return (
    ...
    >
      ...
      <button
        ...
        onClick={() =>
          canOpen &&
          openTerminal(selectedServer!.id, selectedServer!.name, {
            connectionLabel: getTerminalConnectionLabel(selectedServer!),
            isLocal: isTerminalLocal(selectedServer!),
          })
        }
        disabled={!canOpen}
